...
// ====================================================================
// BY US NOT DOCTOR
struct FreePagesInfo
{
	uint32 va;
	uint32 no_consecutive_pages;
	LIST_ENTRY(FreePagesInfo) prev_next_info;	/* linked list links */
};

LIST_HEAD(MemPage_LIST, FreePagesInfo);
struct MemPage_LIST freePagesList_KH;
//======================================================================
...
uint32 *START_KHEAP_BLOCK_ALLOCATOR;
uint32 *BRK;
uint32 *HARD_LIMIT;

uint32 KH_page_allocator_flag;
