...
int map_frame(uint32 *ptr_page_directory, struct FrameInfo *ptr_frame_info, uint32 virtual_address, int perm)
{
	...
	ptr_frame_info->base_va_page = (uint32 *)virtual_address; // By US not Doctor
	...
	//cprintf("HERE AT THE END OF MAP \n");
	//cprintf("perms: %d \n",perm);
	/*********************************************************************************/
...
void unmap_frame(uint32 *ptr_page_directory, uint32 virtual_address)
{
	...
	if( ptr_frame_info != 0 )
	{
		...
		/*********************************************************************************/
		ptr_frame_info->base_va_page = (uint32 *)NULL; // BY US NOT DOCTOR
