...
//uint32 marked_pages_size[USER_HEAP_MAX - ((uint32)myEnv->USERH_HARD_LIMIT + 4096)] = {0};
...
struct Env {
	...
	//struct MemPage_LIST freePagesList_UH ; // List of free pages in USER HEAP FOR EACH Process
	//=======================================================================
	//TODO: [PROJECT'24.MS2 - #10] [3] USER HEAP - add suitable code here
	// lkol process hyb2a leha user heap bta3ha
	uint32 *USERH_START;
	uint32 *USERH_BRK;
	uint32 *USERH_HARD_LIMIT;

	//uint32 marked_pages_size[USER_HEAP_MAX - ( + 4096)] = {0};
	//uint32 marked_page_size[131072]; // BY US NOT DOCTOR <----------------
